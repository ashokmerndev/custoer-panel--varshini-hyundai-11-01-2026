...
import { User, Mail, Lock, Phone, Eye, EyeOff, AlertCircle, ArrowRight, Sparkles, CheckCircle2, Home, Sun, Moon } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // If your hook doesn't have register, replace this with direct API call
      ...
      >
        ...
        <div className={`relative hidden lg:flex flex-col justify-between p-12 overflow-hidden ${
           ...
           <div className="relative z-10 space-y-4">
              ...
              <div className="space-y-3 pt-2">
                {['Track Orders', 'Exclusive Deals', 'Faster Checkout'].map((item, i) => (
        ...
        <div className={`p-8 lg:p-12 flex flex-col justify-center transition-colors duration-500 ${
           ...
           <div className="mb-6 text-center lg:text-left">
              ...
              <p className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Join us to manage your spare parts effortlessly.</p>
           </div>
           ...
           <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                <label className={`text-xs font-semibold uppercase ml-1 ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>Full Name</label>
              ...
              {/* Phone Number */}
              <div className="space-y-1.5">
                <label className={`text-xs font-semibold uppercase ml-1 ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>Phone</label>
                <div className="relative group">
           ...
           <div className={`mt-6 pt-6 border-t text-center ${isDarkMode ? 'border-white/5' : 'border-gray-200'}`}>
