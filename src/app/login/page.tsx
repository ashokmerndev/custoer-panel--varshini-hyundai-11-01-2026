  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // Note: Your API sends 'message', so use it here
        setError(
  ...
  opacity-95"
          ...
          <div className="relative z-10 space-y-4">
            ...
            <div className="space-y-3 pt-2">
              {["Genuine Parts", "Express Delivery", "Expert Support"].map(
                (item, i) => (
                  <div
                    key={i}
        ...
        >
          ...
          <div
            className={`mt-8 pt-6 border-t text-center ${isDarkMode ? "border-white/5" : "border-gray-200"}`}
          >
            <p
