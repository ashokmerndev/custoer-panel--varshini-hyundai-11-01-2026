...
export default function Home() {
  ...
  return (
    // 👇 Main Container: Responsive padding & Theme colors
      ...
      <section className="relative overflow-hidden min-h-[500px] md:min-h-[600px] flex items-center bg-gray-100 dark:bg-[#050B14]">
        ...
        <div className="absolute inset-0 opacity-30 dark:opacity-20 pointer-events-none">
          <motion.div
            ...
            animate={{
              transform: ['translate(0,0) rotate(0deg)', 'translate(-20px,20px) rotate(10deg)', 'translate(0,0) rotate(0deg)'],
            }}
            transition={{
              duration: 10,
              repeat: Infinity,
      ...
      <section id="products" className="py-16 px-4 md:px-8 bg-white dark:bg-[#0A101F] transition-colors duration-300">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-6 mb-12">
            ...
            >
              <Filter size={20} className="text-hyundai-blue flex-shrink-0 mr-2" />
