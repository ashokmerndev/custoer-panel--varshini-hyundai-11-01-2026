        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-6">
              Get in <span className="text-transparent bg-clip-text bg-gradient-to-r from-hyundai-blue to-blue-500">Touch</span>
            </h1>
            <p className="max-w-2xl mx-auto text-lg text-gray-600 dark:text-gray-300">
              Have a question about a spare part? Need help with an order? Our team is here to assist you.
            </p>
          </motion.div>
        </div>
      </section>
...
function ContactCard({ icon, title, content, subContent, delay }: { icon: any, title: string, content: string, subContent?: string, delay: number }) {
  return (
    <motion.div 
      initial={{ opacity: 0, y: 20 }}
      animate={{ opacity: 1, y: 0 }}
    ...
    >
      ...
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-300 mt-1 font-medium">{content}</p>
